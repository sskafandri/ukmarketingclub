    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="dashboard.php?c=servers" class="btn btn-warning" >Servers</a>
...
<div class="modal fade" id="modal-terms">
    <div class="modal-dialog" style="width: 80%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
    <h2>Welcome to UKMarketingClub</h2>
        <p>These terms and conditions outline the rules and regulations for the use of UKMarketingClub's Website.</p> <br /> 

        <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use UKMarketingClub's website 
        ...
        <p>We employ the use of cookies. By using UKMarketingClub's website you consent to the use of cookies 
        in accordance with UKMarketingClub's privacy policy.</p><p>Most of the modern day interactive web sites
        use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
        to enable the functionality of this area and ease of use for those people visiting. Some of our 
        affiliate / advertising partners may also use cookies.</p><h2>License</h2>
        <p>Unless otherwise stated, UKMarketingClub and/or it's licensors own the intellectual property rights for
        all material on UKMarketingClub. All intellectual property rights are reserved. You may view and/or print
        pages from https://www.ukmarketingclub.com for your own personal use subject to restrictions set in these terms and conditions.</p>
        <p>You must not:</p>
        <ol>
            <li>Republish material from https://www.ukmarketingclub.com</li>
            <li>Sell, rent or sub-license material from https://www.ukmarketingclub.com</li>
            <li>Reproduce, duplicate or copy material from https://www.ukmarketingclub.com</li>
        </ol>
        <p>Redistribute content from UKMarketingClub (unless content is specifically made for redistribution).</p>
    <h2>Hyperlinking to our Content</h2>
        ...
        the visibility associated with the hyperlink outweighs the absence of UKMarketingClub; and (d) where the
        ...
        you must notify us by sending an e-mail to <a href="mailto:info@ukmarketingclub.com" title="send an email to info@ukmarketingclub.com">info@ukmarketingclub.com</a>.
        ...
        <p>No use of UKMarketingClub's logo or other artwork will be allowed for linking absent a trademark license
        agreement.</p>
    <h2>Iframes</h2>
