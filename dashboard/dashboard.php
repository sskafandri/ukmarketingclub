  			...
  			<script id="code">
				function init() {
				    ...
				    myDiagram=$(go.Diagram, "myDiagramDiv", // must be the ID or reference to div
				    {
				        ...
				        allowCopy: false, layout: // create a TreeLayout for the family tree
				        $(go.TreeLayout, {
				    ...
				    , 
				    $(go.TextBlock, {
				        font: "bold 8pt Helvetica, bold Arial, sans-serif", wrap: go.TextBlock.WrapFit, margin: 5
				    }
				    , 
				    ...
				    new go.Binding("text", "name"), $(go.Shape, "Rectangle", {
				        fill: "lightgray", stroke: null, strokeWidth: 0, stretch: go.GraphObject.Fill, alignment: go.Spot.Center
				    }
				    , 
				    new go.Binding("fill", "gender", genderBrushConverter)), $(go.TextBlock, {
				        font: "700 12px Droid Serif, sans-serif", textAlign: "center", margin: 10, maxSize: new go.Size(80, NaN)
				    }
				    , 
				    ...
				    var nodeDataArray=[ 
				    {
				        key: 0, name: "Jamie Whittingham", gender: "M", birthYear: "Top"
				    }
				    ,
				    {
				        key: 1, parent: 0, name: "Ian Orford", gender: "M", birthYear: "1"
				    }
				    ,
				    {
