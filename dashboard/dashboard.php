		                    	...
		                    	<?php foreach($downline[2] as $level_2) { ?>
		                    		<?php foreach($customers as $customer) { ?>
		                    			<?php if($customer['upline_id']==$level_2) {?>
				                        	{ id: "<?php echo $customer['id']; ?>", pid: "<?php echo $customer['upline_id']; ?>", Name: "<?php echo $customer['first_name']; ?> <?php echo $customer['last_name']; ?>", Level: "Level 2", email: "<?php echo $customer['email']; ?>", img: "<?php echo $customer['avatar']; ?>" },
		                    	...
		                    	<?php foreach($downline[3] as $level_3) { ?>
		                    		<?php foreach($customers as $customer) { ?>
		                    			<?php if($customer['upline_id']==$level_3) {?>
				                        	{ id: "<?php echo $customer['id']; ?>", pid: "<?php echo $customer['upline_id']; ?>", Name: "<?php echo $customer['first_name']; ?> <?php echo $customer['last_name']; ?>", Level: "Level 3", email: "<?php echo $customer['email']; ?>", img: "<?php echo $customer['avatar']; ?>" },
		                    	...
		                    	<?php foreach($downline[4] as $level_4) { ?>
		                    		<?php foreach($customers as $customer) { ?>
		                    			<?php if($customer['upline_id']==$level_4) {?>
				                        	{ id: "<?php echo $customer['id']; ?>", pid: "<?php echo $customer['upline_id']; ?>", Name: "<?php echo $customer['first_name']; ?> <?php echo $customer['last_name']; ?>", Level: "Level 4", email: "<?php echo $customer['email']; ?>", img: "<?php echo $customer['avatar']; ?>" },
		                    	...
		                    	<?php foreach($downline[5] as $level_5) { ?>
		                    		<?php foreach($customers as $customer) { ?>
		                    			<?php if($customer['upline_id']==$level_5) {?>
				                        	{ id: "<?php echo $customer['id']; ?>", pid: "<?php echo $customer['upline_id']; ?>", Name: "<?php echo $customer['first_name']; ?> <?php echo $customer['last_name']; ?>", Level: "Level 5", email: "<?php echo $customer['email']; ?>", img: "<?php echo $customer['avatar']; ?>" },
		                    	...
		                    	<?php foreach($downline[6] as $level_6) { ?>
		                    		<?php foreach($customers as $customer) { ?>
		                    			<?php if($customer['upline_id']==$level_6) {?>
				                        	{ id: "<?php echo $customer['id']; ?>", pid: "<?php echo $customer['upline_id']; ?>", Name: "<?php echo $customer['first_name']; ?> <?php echo $customer['last_name']; ?>", Level: "Level 6", email: "<?php echo $customer['email']; ?>", img: "<?php echo $customer['avatar']; ?>" },
		                    	...
		                    	<?php foreach($downline[7] as $level_7) { ?>
		                    		<?php foreach($customers as $customer) { ?>
		                    			<?php if($customer['upline_id'] == $level_7) {?>
				                        	{ id: "<?php echo $customer['id']; ?>", pid: "<?php echo $customer['upline_id']; ?>", Name: "<?php echo $customer['first_name']; ?> <?php echo $customer['last_name']; ?>", Level: "Level 7", email: "<?php echo $customer['email']; ?>", img: "<?php echo $customer['avatar']; ?>" },
