		                    	...
		                    	<?php foreach($downline[$downline_current] as $level) { ?>
		                    		<?php foreach($customers as $customer) { ?>
		                    			<?php if($customer['upline_id']==$level) {?>
				                        	...
				                        	{ id: <?php echo $customer['id']; ?>, pid: <?php echo $customer['upline_id']; ?>, name: "<?php echo $customer['first_name']; ?> <?php echo $customer['last_name']; ?>", title: "QA Lead", email: "<?php echo $customer['email']; ?>", img: "<?php echo $customer['avatar']; ?>" },
